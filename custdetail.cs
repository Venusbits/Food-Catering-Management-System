...
{
    public partial class custdetail : Form
    {
        ...
        void GetmaxID()
        {
            textBox1.Text = db.GetAutoID("Select MAX(ID) from custdetail").ToString();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.ExecuteSqlQuery("Insert into custdetail(ID,Name,Email,contact,Address)values(" + textBox1.Text + ",'" + textBox2.Text + "','" + textBox4.Text + "','" + textBox3.Text + "','" + textBox5.Text + "')");
                db.FillGridData(dataGridView1, "Select * from custdetail");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            db.ExecuteSqlQuery("Update custdetail SET Name='" + textBox2.Text + "',contact='" + textBox3.Text + "',Email='" + textBox4.Text + "',Address='" + textBox5.Text + "' where ID=" + textBox1.Text);
            db.FillGridData(dataGridView1, "Select * from custdetail");
        ...
        private void custdetail_Load(object sender, EventArgs e)
        {
            db.FillGridData(dataGridView1, "select * from custdetail ");
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    db.FillGridData(dataGridView1, "Select * from custdetail where ID=" + textBox6.Text + "");
                }
                else if (comboBox1.SelectedIndex == 1)
                {
                    db.FillGridData(dataGridView1, "Select * from custdetail where Name like'" + textBox6.Text + "%'");
                }
                else
                {
                    db.FillGridData(dataGridView1, "Select * from custdetail where contact like '" + textBox6.Text + "%'");
                }
